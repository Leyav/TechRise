    ...
    <footer className="pt-16 bg-darkmode">
      <div className="container mx-auto lg:max-w-screen-xl md:max-w-screen-md px-4">
        <div className="grid grid-cols-1 sm:grid-cols-5 lg:gap-20 md:gap-6 sm:gap-12 gap-6  pb-16">
          ...
          <img src="/images/logo/mLogo.svg" alt="Logo" className="w-8 h-8" />
            ...
            <div className="flex gap-6 items-center">
              <Link to="#" className="group bg-white hover:bg-primary rounded-full shadow-xl p-3">
                <Icon
        ...
        <div className="border-t border-grey/15 dark:border-white/15 py-10 flex justify-between items-center">
          ...
          ©2025 - TechRise. Distributed and Developed By <Link to="https://leytech.com/" target="_blank" className="hover:text-primary">LeyTech</Link>
          </p>

          <div className="">
            <Link to="#" className="text-sm text-black/70 dark:text-white/70 px-5 border-r border-grey/15 dark:border-white/15 hover:text-primary dark:hover:text-primary">Privacy policy</Link>
            <Link to="#" className="text-sm text-black/70 dark:text-white/70 px-5 hover:text-primary dark:hover:text-primary">Terms & conditions</Link>
          </div>
        </div>
      </div>
    </footer>
