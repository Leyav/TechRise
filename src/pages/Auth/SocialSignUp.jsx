...
const SocialSignUp = () => {
  ...
  const handleGithubSignIn = () => {
    // TODO: Add GitHub sign-in logic here
  ...
  return (
    <div className="flex gap-4">
      ...
      <button
        ...
        className="flex w-full items-center justify-center gap-2.5 rounded-lg p-3.5 bg-primaryPurple hover:bg-primary/40 text-white"
      >
        Sign Up
        <svg
          width="22"
