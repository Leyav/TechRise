    ...
    <section>
      <div className="container mx-auto lg:max-w-screen-xl md:max-w-screen-md" id="about-section">
        <div className="text-center mb-14">
          <p className="text-primaryPurple text-lg font-normal mb-3 tracking-widest uppercase">Features</p>
          ...
          {FeaturesData.map((items, i) => (
            ...
            >
              <div className="work-img-bg rounded-full flex justify-center absolute -top-[50%] sm:top-[-40%] md:top-[-55%] lg:top-[-45%] left-[0%]">
                <img src={items.imgSrc} alt={`feature-${i}`} width={510} height={10} />
              </div>
              ...
              <div className="flex items-center justify-center">
                ...
                >
                  Learn More
                  <Icon icon="tabler:chevron-right" width="24" height="24" className="text-primary" />
                </a>
              </div>
            </div>
          ))}
