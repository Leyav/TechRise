    ...
    return (
        <section className='relative'>
            <div className="container mx-auto lg:max-w-screen-xl md:max-w-screen-md">
                <div className="bg-primaryPurple rounded-Newsletter grid grid-cols-1 gap-y-10 gap-x-6 md:grid-cols-12 xl:gap-x-8">
                    ...
                    <div className="col-span-5 relative hidden md:block">
                        ...
                        <div className="absolute bottom-[20%] right-[20%]">
                            <img src="/images/home/Newsletter/blue.svg" alt="blue-image" width={25} height={25} />
                        </div>
                    </div>
